...
(* OASIS_START *)
(* DO NOT EDIT (digest: a4434c8a942658d3b2447e210be9f685) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("milter", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("milter", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Milter documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some ")\168/ k\137o\184\237\253\222\228\186$X\210";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
